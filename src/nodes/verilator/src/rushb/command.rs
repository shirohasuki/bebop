...
pub(crate) type CommandReceiver = mpsc::Receiver<Result<CommandResponse, String>>;
...
pub(crate) fn submit(
    ...
    wait: WaitMode,
    dma: DmaOperation,
) -> Result<(u64, CommandReceiver), String> {
...
pub(crate) fn execute(
    ...
    let (command_id, receiver) = submit(accelerator_id, chip_id, xs1, xs2, funct7, wait, dma)?;
    receiver
        .recv()
